...
public extension UIScrollView {
    ...
    public func spr_setIndicatorHeader(height: CGFloat = DefaultSPTR.short,
    ...
    ///   - height: refresh view height and also the trigger requirement, default is 60
    ///   - action: refresh action
    public func spr_setTextHeader(loadingText: String = DefaultSPTR.loadingText,
                                  pullingText: String = DefaultSPTR.pullingText,
                                  releaseText: String = DefaultSPTR.releaseText,
                                  height: CGFloat = DefaultSPTR.short,
                                  action: @escaping () -> Void) {
    ...
    public func spr_setGIFTextHeader(data: Data,
                                     loadingText: String = DefaultSPTR.loadingText,
                                     pullingText: String = DefaultSPTR.pullingText,
                                     releaseText: String = DefaultSPTR.releaseText,
                                     height: CGFloat = DefaultSPTR.short,
                                     action: @escaping () -> Void) {
    ...
    ///   - height: refresh view height and also the trigger requirement, default is 60
    ///   - action: refresh action
    public func spr_setIndicatorFooter(height: CGFloat = DefaultSPTR.short,
                                       action: @escaping () -> Void) {
    ...
    ///   - height: refresh view height and also the trigger requirement, default is 60
    ///   - action: refresh action
    public func spr_setTextFooter(loadingText: String = DefaultSPTR.loadingText,
                                  pullingText: String = DefaultSPTR.pullingFooterText,
                                  releaseText: String = DefaultSPTR.releaseFooterText,
                                  height: CGFloat = DefaultSPTR.short,
                                  action: @escaping () -> Void) {
        let textItem = TextItem(loadingText: loadingText, pullingText: pullingText, releaseText: releaseText)
    ...
    ///   - height: refresh view height and also the trigger requirement, default is 60
    ///   - action: refresh action
    public func spr_setIndicatorAutoFooter(height: CGFloat = DefaultSPTR.short,
                                           action: @escaping () -> Void) {
    ...
    ///   - height: refresh view height and also the trigger requirement, default is 60
    ///   - action: refresh action
    public func spr_setTextAutoFooter(loadingText: String = DefaultSPTR.loadingText,
                                      height: CGFloat = DefaultSPTR.short,
                                      action: @escaping () -> Void) {
